...
function Countdown3({ onClick }) {
  const quitRef = React.useRef(Date.now() - ((93 * 86400 + 6 * 3600 + 19 * 60 + 34) * 1000));
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '58px 20px 10px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 22 }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: ISK3.brandDeep }}>98</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <StatCard3 cat="novac" onClick={() => window.MoneyScreen && setView('money')} icon={(c) => <CoinIcon3 size={20} stroke={c} sw={2} />} value="42.600" label="RSD uštedeno" />
            <StatCard3 cat="cigare" onClick={() => window.CigarettesScreen && setView('cigarettes')} icon={(c) => <CigOffIcon3 size={20} stroke={c} sw={1.9} />} value="2080" label="cigareta odbijeno" />
          </div>
...
Object.assign(window, { HomeScreenTeaser });
